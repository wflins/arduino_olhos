...
void setup(){
  Serial.begin(115200);pinMode(CONFIG_BUTTON,INPUT_PULLUP);tft.initR(INITR_BLACKTAB);tft.setRotation(1);telaLimpa();determinarModoInicial();LittleFS.begin();carregarConfig();
